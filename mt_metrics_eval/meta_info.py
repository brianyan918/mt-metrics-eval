...
DATA = {
    ...
    'wmt24': {
        ...
        'en-de_doc': dataclasses.replace(WMT24, std_ref='refB'),
        'en-es': WMT24,
        'en-es_doc': WMT24,
        'ja-zh': WMT24,
        'ja-zh_doc': WMT24,
    ...
    'wmt23': {
        ...
        'en-de_doc': dataclasses.replace(WMT23, outlier_systems={'synthetic_ref'}),
        'xx-xx': dataclasses.replace(WMT23, outlier_systems={'synthetic_ref'}),
        'he-en': dataclasses.replace(WMT23, std_ref='refB'),
        'he-en_doc': dataclasses.replace(WMT23, std_ref='refA'),
        'zh-en': dataclasses.replace(WMT23, outlier_systems={'synthetic_ref'}),
        'zh-en_doc': dataclasses.replace(WMT23, outlier_systems={'synthetic_ref'}),
        'cs-uk': WMT23_DA,
        'de-en': WMT23_DA,
        'en-cs': WMT23_DA,
